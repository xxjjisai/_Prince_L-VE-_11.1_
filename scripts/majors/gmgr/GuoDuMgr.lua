...
function GuoDuMgr:Render()
    ...
    if self.bStart then 
        ...
        love.graphics.setFont(AssetsMgr:GetFont(362));
        -- love.graphics.print(GameTextCfg.GetTextFunc(10005), (graphicsWidth*0.5) - AssetsMgr:GetFont(362):getWidth(GameTextCfg.GetTextFunc(10005))*0.5,graphicsHeight*0.8);
        love.graphics.setColor(1,1,1,1);
